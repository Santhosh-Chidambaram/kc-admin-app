...
import ChannelList from './cusFlatList/ChannelList'
...
function ChannelScreen({navigation}) {
    ...
    const {getChannelsList,channellist,setChannelCost,channelcost,setChannelArray,setChannels} = mainContext;
