...
import PackList from './cusFlatList/PackList'
...
export default function PackageScreen({navigation}) {
    ...
    const {getPackagesList,packagelist,setPackageCost,packagecost,setPackArray,setPackages} = mainContext;
